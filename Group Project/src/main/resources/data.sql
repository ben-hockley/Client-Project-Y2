...
values ('Test User','MoicoT@cardiff.ac.uk','1234567890','Yorkshire_and_the_Humber','TestOldJob1, TestOldJob2','Test Location',1,TRUE,'2021-01-01','TestCVPath', false),
       ('Alice Johnson','alice.johnson@example.com','2345678901','Wales','Developer','Junior Developer',2,FALSE,'2022-02-01','AliceCVPath', false),
       ('Bob Smith','bob.smith@example.com','3456789012','London','Manager','Assistant Manager',3,TRUE,'2022-03-01','BobCVPath', false),
       ('Charlie Brown','charlie.brown@example.com','4567890123','London','Analyst','Junior Analyst',4,FALSE,'2022-04-01','CharlieCVPath', false),
       ('Diana Prince','diana.prince@example.com','5678901234','Wales','Designer','Junior Designer',1,TRUE,'2022-05-01','DianaCVPath', false),
       ('Eve Adams','eve.adams@example.com','6789012345','London','Engineer','Junior Engineer',2,FALSE,'2022-06-01','EveCVPath', true),
       ('Frank Wright','frank.wright@example.com','7890123456','Wales','Consultant','Junior Consultant',3,TRUE,'2022-07-01','FrankCVPath', false),
       ('Grace Lee','grace.lee@example.com','8901234567','North_East','Architect','Junior Architect',4,FALSE,'2022-08-01','GraceCVPath', true),
       ('Hank Green','hank.green@example.com','9012345678','Wales','Scientist','Junior Scientist',1,TRUE,'2022-09-01','HankCVPath', false),
       ('Ivy White','ivy.white@example.com','0123456789','West_Midlands','Technician','Junior Technician',2,FALSE,'2022-10-01','IvyCVPath', false);
