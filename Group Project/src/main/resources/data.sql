...
insert into applicants (name, email, phone, location, eventID, isInternal, startDate)
values ('Test User','test@test.com','1234567890','Test Location',1,TRUE,'2021-01-01');
